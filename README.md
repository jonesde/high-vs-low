...
**Legal library.** Concrete, citable cases of preferential legal application — outcomes the formal system enables for some parties while closing or criminalizing analogous conduct for others — live in [`legal-library/`](legal-library/README.md) (pla-001–086, eight arcs plus a light healthcare pair). Each entry names the outcome, the statutes and procedures used, the evidence of differential routing, and the matching distinction rules. The arcs are track-switching, technique enclosure, earth and money, protected complexes (compulsion outside, immunity inside), institutional religion (belief and speech versus the entity franchise), institutional charity (local aid versus the asset-protecting franchise), housing (the analog person and the roof), and education (instruction versus the credential franchise), plus chargemaster/CON as price and entry walls. Receipts on church opacity, clergy tax, and supporting orgs were deepened in the same pass. It is a knowledge base for the skill, not a scored evaluation corpus.
