...
**Legal library.** Concrete, citable cases of preferential legal application — outcomes the formal system enables for some parties while closing or criminalizing analogous conduct for others — live in [`legal-library/`](legal-library/README.md). Each entry names the outcome, the statutes and procedures used, the evidence of differential routing, and the matching distinction rules. Clusters cover technique enclosure, legal interposition between people and earth resources (including money issue), and protected complexes (compulsion outside, immunity inside), including institutional religion (belief and speech versus the entity franchise) and institutional charity (local aid versus the asset-protecting franchise). It is a knowledge base for the skill, not a scored evaluation corpus.
