...
**Feed the Flock** is a pastoral religious address (likely delivered by a Latter-day Saint General Authority) that uses personal anecdotes, scriptural references, and chaplain reports to exhort church leaders and families to actively care for young people serving in the military. The speaker emphasizes the emotional toll of isolation, criticizes institutional neglect, and challenges the audience to replace passive ritual with tangible affection, letters, and consistent communication.

The text is overwhelmingly **High Law aligned** in its normative stances. While it employs religious vocabulary (prophets, sin, devil, divine command), the underlying principles championed are relational, voluntary, and centered on compassion, mutual care, and the protection of the vulnerable. The author consistently frames leadership and faith as active stewardship rather than coercive control, explicitly rejecting empty ritual in favor of practical love. The dominant framework is High Law, with religious language functioning as a vehicle for relational ethics rather than a mechanism for legalistic obedience.

---

## Key Topics

1. **Community and Belonging: Pastoral Care & Emotional Support**
2. **Community and Belonging: Leadership Responsibility**
3. **Mercy and Compassion: Active Affection & Connection**
4. **Suffering and Harm: Neglect & Isolation**
5. **Suffering and Harm: Consequences of Neglect**
6. **Transformation and Growth: Encouragement & Moral Guidance**
7. **Transformation and Growth: Practical Action over Ritual**

---

## Statement Quotes

### High Law Aligned (13 statements)

| # | Location | Rules | Decision Notes | Key Topics | Speaker | Stance Quote | Principle Quote |
|---| -------- | ----- | -------------- | ---------- | ------- | ------------ | --------------- |
| 1 | L10 | 10-HL, 12-HL, 4-HL | Voluntary invitation, friendly posture, compassion over control | Community and Belonging: Pastoral Care & Emotional Support; Mercy and Compassion: Active Affection & Connection | Author | "I put my arm around him and told him we were at the base for a brief meeting with our Church members, and hoped that he would attend... 'We will be honored if you come to our meeting. The Church cares about you. Come and join us. We’re your friends.'" | Help: wanted or unwanted? Starting posture: benefit of the doubt or suspicion? |
| 2 | L28 | 10-HL, 36-HL | Opposes neglect, supports care as divine plan | Suffering and Harm: Neglect & Isolation; Community and Belonging: Pastoral Care & Emotional Support | Author | "This lack of interest at home for these young men is not the Lord’s plan, not the way he has taught us." | Treatment of the Least: care or sacrifice? Help: wanted or unwanted? |
| 3 | L35 | 10-HL, 36-HL | Supports intensified care for isolated members | Community and Belonging: Pastoral Care & Emotional Support | Author | "This responsibility to teach and to encourage does not cease because they are out of sight; in fact, our interest must be intensified." | Help: wanted or unwanted? Treatment of the Least: care or sacrifice? |
| 4 | L42 | 36-HL, 10-HL | Prioritizes vulnerable/lonely over established members | Suffering and Harm: Neglect & Isolation; Community and Belonging: Pastoral Care & Emotional Support | Author | "Our concern is not for the career military Church member who, with his family, adds great strength to local Church units, but for the young men—mostly single, lonely, exposed to the evil enticements and temptations that can be part of military life." | Treatment of the Least: care or sacrifice? Help: wanted or unwanted? |
| 5 | L52 | 10-HL, 36-HL | Supports leaders encouraging members voluntarily | Community and Belonging: Leadership Responsibility | Author | "Why shouldn’t parents, bishops, and elders presidents treat these 20,000 in the military as missionaries? ... You are their Church leaders and should be continually encouraging them." | Help: wanted or unwanted? Treatment of the Least: care or sacrifice? |
| 6 | L68 | 10-HL, 36-HL | Supports guidance/protection for youth needs | Transformation and Growth: Encouragement & Moral Guidance; Community and Belonging: Pastoral Care & Emotional Support | Author | "Bishops, counsel our young women concerning the grave dangers and pitfalls because of the lack of moral guidance." | Help: wanted or unwanted? Treatment of the Least: care or sacrifice? |
| 7 | L72 | 10-HL, 36-HL | Supports moral support for those struggling | Transformation and Growth: Encouragement & Moral Guidance; Suffering and Harm: Neglect & Isolation | Author | "Many of the single men are floundering on the cutting edge of sin. They are saying, “Please help me.” There is no hometown moral support that goes unappreciated." | Help: wanted or unwanted? Treatment of the Least: care or sacrifice? |

### Low Law Aligned (0 statements)
...
| -------- | ----- | ---------- |
| High Law Aligned | 7 | 100.0% |
| Low Law Aligned | 0 | 0.0% |
| **Total** | **7** | **100%** |

**Score**: ((100.0 - 0.0) / 10) = **10.0**
...
| --------- | ------ | ----- | ----- |
| Community and Belonging: Pastoral Care & Emotional Support | 7 | 0 | 10.0 |
| Community and Belonging: Leadership Responsibility | 1 | 0 | 10.0 |
| Mercy and Compassion: Active Affection & Connection | 2 | 0 | 10.0 |
| Suffering and Harm: Neglect & Isolation | 3 | 0 | 10.0 |
| Suffering and Harm: Consequences of Neglect | 2 | 0 | 10.0 |
| Transformation and Growth: Encouragement & Moral Guidance | 2 | 0 | 10.0 |
| Transformation and Growth: Practical Action over Ritual | 1 | 0 | 10.0 |
"""
