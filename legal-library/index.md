...
| ID | Entry | Outcome | Enabled | Closed | Domains |
| -- | ----- | ------- | ------- | ------ | ------- |
...
| pla-007 | [Employee theft on the criminal track](employee-theft-criminal-track.md) | Criminal exposure for modest employee taking | criminal, civil | non-action | labor, property |
| pla-008 | [Secured credit and foreclosure](secured-credit-foreclosure.md) | Priority recovery through security and foreclosure | civil, contractual | civil (equal unsecured recovery) | capital-access, debt |
| pla-009 | [Zoning incumbent protection](zoning-incumbent-protection.md) | Land-use barriers that protect existing uses | administrative, regulatory, civil | administrative (as-of-right entry) | land-use, regulatory-control |
...
- [pla-001 Unpaid wages on the civil track](unpaid-wages-civil-track.md) (wages as taken property)
...
## Browse by routing pattern

**Civil-enabled / criminal-closed.** The taking or deceit is real; the felony file is not, when the defendant is an institution or employer.

- [pla-001](unpaid-wages-civil-track.md), [pla-006](consignment-civil-conversion.md), [pla-010](white-collar-civil-routing.md)
...
**Track-switching by party status.** The act is similar; the caption is not. Employer wage underpayment, franchise-inventory fights, and large financial cases stay civil. Employee theft and small fraud go criminal. See [pla-001](unpaid-wages-civil-track.md), [pla-006](consignment-civil-conversion.md), [pla-007](employee-theft-criminal-track.md), [pla-010](white-collar-civil-routing.md). Distinction rules 1, 25, 28, 36, 38 in [SKILL.md](../SKILL.md).

**Procedural cost as the real filter.** Forfeiture claimants, patent defendants, and unsecured debtors lose because the process costs more than the stake, or more than they have. See [pla-002](civil-asset-forfeiture.md), [pla-004](patent-assertion-entities.md), [pla-008](secured-credit-foreclosure.md). Rules 22, 40.
...
1. Confirm all four inclusion tests in the [README](README.md#inclusion-rule).
2. Copy the frontmatter and body sections from the [document specification](README.md#document-specification).
3. Assign the next `pla-NNN` id. Use only listed domain and routing tokens.
4. Write **Framework notes** against the [Distinction Rule Table](../SKILL.md). Do not score.
5. Add a row to the catalog on this page and a bullet under each relevant domain and routing heading.
6. Cross-link `related` slugs in both directions.
